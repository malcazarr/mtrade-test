            ...
            <div className="header-card">
                <div className="header-card-collapse d-flex justify-content-between">
                    <div className="Roboto-mono font-14 d-flex justify-content-start">
                        ...
                        <div className="main-card d-none d-sm-none d-md-block"><li className="d-none d-sm-none d-md-block">{data.datos[data.datos.length - 1].dato}</li></div>
                        <div className="main-card d-none d-sm-none d-md-block">{data.datos[data.datos.length - 1].fecha}</div>
                        <div className="main-card d-none d-sm-none d-md-block">Graph</div>
                        <div 
            ...
            <Collapse in={accordion}>
                <div className="body-card" >
                    ...
                    <div className="d-sm-block d-md-none">
                        <CarouselData data={data} metadata={metadata}></CarouselData>
                    </div>
                    <div>
